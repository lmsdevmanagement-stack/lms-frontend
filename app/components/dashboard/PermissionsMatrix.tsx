...
export default function PermissionsMatrix({ section }: PermissionsMatrixProps) {
    ...
    <Card>
      <CardHeader className="border-b border-slate-200">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <CardTitle>{PERMISSION_PAGE_TITLES[section]}</CardTitle>
            <p className="mt-1 text-sm text-slate-500">Manage access by module and action.</p>
          </div>
