...
export const DASHBOARD_NAV_ITEMS: NavigationItem[] = [
  ...
  { id: 'schedule', label: 'Schedule', icon: CalendarCheck, roles: [USER_ROLES.teacher] },
  { id: 'work', label: 'Class Work', icon: Layers, roles: [USER_ROLES.teacher] },
  { id: 'results', label: 'Results', icon: BarChart3, roles: [USER_ROLES.teacher] },
  ...
  { id: 'schedule', label: 'Schedule', icon: CalendarCheck, roles: [USER_ROLES.student] },
  { id: 'work', label: 'Class Work', icon: Layers, roles: [USER_ROLES.student] },
  { id: 'results', label: 'Marks', icon: BarChart3, roles: [USER_ROLES.student] },
